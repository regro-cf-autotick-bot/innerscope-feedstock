...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/innerscope-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13824&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/innerscope-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `innerscope` can be installed with:

```
conda install innerscope
```

It is possible to list all of the versions of `innerscope` available on your platform with:
